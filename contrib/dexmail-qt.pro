...
RESOURCES += src/qt/dexmail.qrc src/qt/dexmail_locale.qrc

TRANSLATIONS += src/qt/locale/dexmail_bg.ts \
                src/qt/locale/dexmail_de.ts \
                src/qt/locale/dexmail_en.ts \
                src/qt/locale/dexmail_es.ts \
                src/qt/locale/dexmail_fi.ts \
                src/qt/locale/dexmail_fr.ts \
                src/qt/locale/dexmail_it.ts \
                src/qt/locale/dexmail_ja.ts \
                src/qt/locale/dexmail_pl.ts \
                src/qt/locale/dexmail_pt.ts \
                src/qt/locale/dexmail_ru.ts \
                src/qt/locale/dexmail_sk.ts \
                src/qt/locale/dexmail_sv.ts \
                src/qt/locale/dexmail_vi.ts \
                src/qt/locale/dexmail_zh_CN.ts \
                src/qt/locale/dexmail_zh_TW.ts
