...
#   c) node1 mines 32 blocks, so now node 0 has 500000DXM, node 1 has 4250DXM, node2 has none.
#   d) node0 sends 601 DXM to node2, in two transactions (301 DXM, then 300 DXM).
