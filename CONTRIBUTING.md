Contributing to DEXMail Core
==================================

The DEXMail Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DEXMail Core project, and is not to be
confused with overall DEXMail Network Protocol consensus changes.

Whether a pull request is merged into DEXMail Core rests with the project merge
...
Patches that change DEXMail consensus rules are considerably more involved than
...
Where a patch set proposes to change the DEXMail consensus, it must have been
...
The project leader is the release manager for each DEXMail Core release.
