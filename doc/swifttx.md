...
This mechanism has been integrated into Bitcore-Node-DEXMail which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dexmail/insight-api-dexmail#web-socket-api](https://github.com/dexmail/insight-api-dexmail#web-socket-api)
* API: [https://github.com/dexmail/insight-api-dexmail#swifttx-transactions](https://github.com/dexmail/insight-api-dexmail#swifttx-transactions)
...
By default, the DEXMail Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DEXMail Core daemon:
