...
Intro
-----
DEXMail (DXM) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. DEXMail utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run dexmail-qt.exe.

DEXMail Core is the original DEXMail client and it builds the backbone of the network.
However, it downloads and stores the entire history of DEXMail transactions;
