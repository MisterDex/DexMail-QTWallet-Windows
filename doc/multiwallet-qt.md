...
In order to support loading of multiple wallets in dexmail-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is dexmail.cpp.
...
Changes to dexmail.cpp
----------------------
dexmail.cpp is the entry point into dexmail-qt, and as such, will require some minor modifications to provide hooks for
