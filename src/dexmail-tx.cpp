...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DEXMail Core dexmail-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  dexmail-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dexmail transaction") + "\n" +
                               "  dexmail-tx [options] -create [commands]   " + _("Create hex-encoded dexmail transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dexmail transaction
