                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DEXMail Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DXM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dexmail: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DEXMail Core"), this);
    aboutAction->setStatusTip(tr("Show information about DEXMail Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DEXMail"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DXM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DXM addresses"));
    ...
    openAction->setStatusTip(tr("Open a dexmail: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DEXMail Core help message to get a list with possible DEXMail command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DEXMail Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DEXMail network", "", count));
}
...
{
    QString strTitle = tr("DEXMail Core"); // default title
