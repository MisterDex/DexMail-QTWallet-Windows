...
/** Utility functions used by the DEXMail Qt UI.
 */
namespace GUIUtil
{
...
// Render DXM addresses in monospace font
...
// Parse "dexmail:" URI into recipient object, return true on successful parsing
