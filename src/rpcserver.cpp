...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    StartShutdown();
    return "DEXMail server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DEXMail features */
        {"dexmail", "masternode", &masternode, true, true, false},
        {"dexmail", "listmasternodes", &listmasternodes, true, true, false},
        {"dexmail", "getmasternodecount", &getmasternodecount, true, true, false},
        {"dexmail", "masternodeconnect", &masternodeconnect, true, true, false},
        {"dexmail", "masternodecurrent", &masternodecurrent, true, true, false},
        {"dexmail", "masternodedebug", &masternodedebug, true, true, false},
        {"dexmail", "startmasternode", &startmasternode, true, true, false},
        {"dexmail", "createmasternodekey", &createmasternodekey, true, true, false},
        {"dexmail", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"dexmail", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"dexmail", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"dexmail", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"dexmail", "getmasternodescores", &getmasternodescores, true, true, false},
        {"dexmail", "mnbudget", &mnbudget, true, true, false},
        {"dexmail", "preparebudget", &preparebudget, true, true, false},
        {"dexmail", "submitbudget", &submitbudget, true, true, false},
        {"dexmail", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"dexmail", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"dexmail", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"dexmail", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"dexmail", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"dexmail", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"dexmail", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"dexmail", "checkbudgets", &checkbudgets, true, true, false},
        {"dexmail", "mnsync", &mnsync, true, true, false},
        {"dexmail", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> dexmail-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:37551/\n";
}
