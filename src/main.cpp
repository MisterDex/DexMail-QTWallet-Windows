...
#if defined(NDEBUG)
#error "DEXMail cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in udxm) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1)
           ...
           nSubsidy = 9 * COIN;
       else if (nHeight > 90000 && nHeight <= 110000)
           nSubsidy = 10 * COIN;
       else if (nHeight > 110000 && nHeight <= 120000)
           nSubsidy = 9 * COIN;
       else if (nHeight > 120000 && nHeight <= 150000)
           nSubsidy = 8 * COIN;
       else if (nHeight > 150000 && nHeight <= 240000)
           nSubsidy = 7 * COIN;
       else if (nHeight > 240000 && nHeight <= 330000)
           nSubsidy = 6 * COIN;
       else if (nHeight > 330000 && nHeight <= 420000)
           nSubsidy = 5 * COIN;
       else if (nHeight > 420000 && nHeight <= 541000)
           nSubsidy = 4 * COIN;
       else
           nSubsidy = 3 * COIN;
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // DXM: We use certain sporks during IBD, so check to see if they are
